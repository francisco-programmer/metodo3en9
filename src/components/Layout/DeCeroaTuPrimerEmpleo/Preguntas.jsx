  ...
  return (
    <div className="sm:px-72 px-5 ">
          ...
          <div className="py-5 flex justify-between  sm:px-10 px-5 shadow-md hover:shadow-gray-900">
            <div>
              ...
              >
                ...
                a lo más avanzado, y lograr que puedas conseguir tu primer trabajo ingles y tener exito laboral y económico.
              </p>
            </div>
            <div>
              <IoIosArrowDropdown
          ...
          <div className="py-5 flex justify-between  sm:px-10 px-5 shadow-md hover:shadow-gray-900">
            <div>
              ...
              >
                ...
                electrónico con un enlace donde podrás acceder inmediatamente.
              </p>
            </div>
            <div>
              <IoIosArrowDropdown
      ...
      <p className='pt-20 sm:text-xl text-lg pb-5 text-gray-900 font-poppins '>
        Copyright © 2023 Learning Plus | Curso de Cero a tu primer trabajo en ingles! |Todos
